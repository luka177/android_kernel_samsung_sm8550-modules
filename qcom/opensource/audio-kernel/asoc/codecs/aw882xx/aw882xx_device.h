...
enum AW_FORCE_BOOST_8V_MODE {
	AW_FORCE_BOOST_8V_DISABLE = 0,
	AW_FORCE_BOOST_8V_ENABLE,
};
...
struct aw_device_ops {
	...
	int (*aw_set_force_boost_8v)(struct aw_device *aw_dev, unsigned int mode_flag);
};
...
struct aw_device {
	...
	unsigned int re_min;
	bool reinit_flag;
	unsigned int force_boost_8v_mode;
	...
	struct aw_init_check_desc init_check_desc;
